<script type="text/javascript">
    ...
    function demond_p() {
        ...
        $.ajax({url: "<?php echo base_url(); ?>purchase/demondstatus_p", data: {purchase: val, collection_id: collection_id}, success: function(result) {
                alert(result);
                                ...
                                <div class="col-sm-12 hidden-xs">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <input style="width:160px;" class="input-sm form-control input-s-sm inline" value="<?php echo $ad=$data->ass_director; ?>" disabled/>  
                                            </td>
                                            <td></td>
                                        </tr>
                                            ...
                                            <td>                                              
                                                ...
                                                if ($level == "P") {
                                                    ...
                                                    <select id="p" style="width:160px;" class="input-sm form-control input-s-sm inline">
                                                        ...
                                                        <option value="Price-Process">Price->Process</option>
                                                        <option value="Price-Done">Price->Done</option>
                                                        <option value="Purchase-Process">Purchase->Process</option>>
                                                        <option value="Purchase-Done">Purchase->Done</option>>
                                                    </select><button onclick="demond_p()" class="btn btn-sm btn-white">Apply</button> (<?php echo $data->purchase; ?>)
                                                    <?php } elseif ($level == "P" && $pur == "Price-Done" && $ad=="Approved") { ?>
                                                    <select id="p" style="width:160px;" class="input-sm form-control input-s-sm inline">
                                                        <option value="Purchase-Process">Purchase->Process</option>>
                                                        <option value="Purchase-Done">Purchase->Done</option>>
                                                    </select><button onclick="demond_p()" class="btn btn-sm btn-white">Apply</button> (<?php echo $data->purchase; ?>)                                 
