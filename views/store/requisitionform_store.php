...
<section class="vbox">
    <header class="header bg-success bg-gradient">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#static" data-toggle="tab">New Requisition List</a></li>
            <li class=""><a href="#datagrid" data-toggle="tab">Requisition Form</a></li> 
                                            ...
                                            <div class="m-b">
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        ...
                                                        <form action="<?php echo base_url(); ?>officer/requisition/" method="POST">
