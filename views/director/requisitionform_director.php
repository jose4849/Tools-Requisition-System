...
<section class="vbox">
    <header class="header bg-success bg-gradient">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#static" data-toggle="tab">Requisition Form</a></li>
                                            ...
                                            <div class="m-b">
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        ...
                                                        <form action="<?php echo base_url(); ?>director/requisition/" method="POST">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($result as $data) { ?>   
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a  href="<?php echo base_url(); ?>director/requisitionview/?id=<?php echo $data->requisition_id;  ?>">View</a>
                                                                    </td>
                                                                </tr>
                                                            <? } ?>
                                                        </tbody>
