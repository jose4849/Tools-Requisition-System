...
<section class="vbox">
    <header class="header bg-success bg-gradient">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#static" data-toggle="tab">Product Received</a></li>
            <li class=""><a href="#datagrid" data-toggle="tab">New Product Request</a></li> 
                            ...
                            <tbody>
                                <?php foreach ($result as $data) { ?>   
                                    <tr>
                                        ...
                                        <td>
                                            <a  href="<?php echo base_url(); ?>store/collectionview/?id=<?php echo $data->collection_id; ?>">View</a>
                                        </td>
                                    </tr>
                                <? } ?>
                            </tbody>
                                            ...
                                            <div class="m-b">
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        ...
                                                        <form action="<?php echo base_url(); ?>store/collection/" method="POST">
