<script type="text/javascript">
    $(document).ready(function() {
        $('#selectbox-o').select2({
            ...
            ajax: {
                url: "<?php echo base_url(); ?>officer/product_search_collection",
                dataType: 'json',
                                            ...
                                            <div class="m-b">
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        ...
                                                        <form action="<?php echo base_url(); ?>officer/collection/" method="POST">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($result as $data) { ?>   
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a  href="<?php echo base_url(); ?>officer/collectionview/?id=<?php echo $data->collection_id;  ?>">View</a>
                                                                    </td>
                                                                </tr>
                                                            <? } ?>
                                                        </tbody>
